...
function newInventory($invMake, $invModel, $invDescription, $invImage, $invThumbnail, $invPrice, $invStock, $invColor, $classificationId){
    // Create a connection object using the phpmotors connection function
    $db = phpmotorsConnect();
    // The SQL statement
...
//Contain a function for updating an existing vehicle to the inventory table.
...
//Function that gets list of vehicles based on classification.
...
//Function that gets information for all vehicles
